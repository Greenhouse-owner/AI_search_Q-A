...
class ElasticsearchRetrievalTool(BaseTool):
    ...
    def __init__(self, cfg: Optional[Dict] = None):
        ...
        self.es_user = self.cfg.get('user', 'elastic')
    ...
    def _connect(self):
        ...
        try:
            ...
            if not self.client.ping():
                raise Exception("连接失败，请检查 Elasticsearch 服务状态和配置。")
    ...
    def call(self, params: Union[str, dict], **kwargs) -> str:
        ...
        try:
            ...
            files = params_dict.get('files', [])
        except (json.JSONDecodeError, AttributeError):
            return json.dumps([{'error': '输入参数格式错误，必须是有效的 JSON 字符串或字典。'}], ensure_ascii=False)
